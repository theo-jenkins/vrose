  ...
  if (enabled) {
    return (
      <Link
        key={key}
        href={route}
        className="flex items-center justify-start w-full rounded-lg bg-light-primary-button dark:bg-dark-primary-button text-light-button-text dark:text-dark-button-text hover:scale-105 transition-transform duration-300 p-6 text-xl font-semibold shadow-custom-light dark:shadow-custom-dark"
      >
        {icon && (
